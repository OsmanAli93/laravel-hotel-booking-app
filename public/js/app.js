...
__webpack_require__(/*! ./plugin */ "./resources/js/plugin.js");
...
var night = Math.floor((tomorrow.getTime() - today.getTime()) / dayInSeconds);
...
$('#check-out').on('change', function () {
  ...
  var date2 = $('#check-out').datepicker('getDate');
  var diff = 0;
